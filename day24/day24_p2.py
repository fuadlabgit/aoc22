...
def dfs(maps, turt, steps, alpha, omega):
    ...
    for opt in valid_opts:
        minval = min(minval, dfs(maps, opt, steps+1, alpha,omega))
...
minval = dfs(maps, start_pos, steps=0, alpha=start_pos, omega=end_pos)
print("MINVAL trip 1", minval)
cache = {} 

minval2 = dfs(maps, end_pos, steps= minval, alpha=end_pos, omega=start_pos)
print("MINVAL trip 2", minval2)
cache = {}

minval3 = dfs(maps, start_pos, steps= minval2, alpha=start_pos, omega=end_pos)
print("MINVAL trip 3", minval3)
